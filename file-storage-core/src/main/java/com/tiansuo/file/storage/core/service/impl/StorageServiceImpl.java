package com.tiansuo.file.storage.core.service.impl;
...
import com.tiansuo.file.storage.core.model.bo.CreateUploadUrlRespBO;

import com.tiansuo.file.storage.core.model.entity.FileMetadataInfo;
import com.tiansuo.file.storage.core.service.MinioS3Client;
import com.tiansuo.file.storage.core.service.StorageService;
import com.tiansuo.file.storage.core.util.CommonUtil;
...
public class StorageServiceImpl implements StorageService {
    ...
    private FileMetadataInfo saveMetadataInfo(CreateUploadUrlRespBO createUploadUrlRespBO,
        ...
        // 预览图 0:无 1:有,图片类型默认有缩略图
        fileMetadataInfo.setIsPreview(StorageBucketEnums.IMAGE.getCode().equals(createUploadUrlRespBO.getBucketName()) ? CommonConstant.INTEGER_YES : CommonConstant.INTEGER_NO);
        // 是否私有 0:否 1:是
